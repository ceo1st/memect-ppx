# 我们发布了 PPX 源码：一个面向真实文档场景的 PDF / 图片解析引擎
...
如果希望快速体验，可以直接使用产品站或小程序；如果希望本地部署、二次开发或集成到自己的系统中，可以使用仓库源码和 PyPI 包。

## 为什么选择现在公开发布源码

我们希望 PPX 不只是一个内部可用工具，而是一个能够在更广泛文档场景中被验证、被改进、被复用的源码可见基础能力。
...
我们希望 PPX 不只是一个能跑起来的工具，而是一个能够在真实文档场景中长期生长、持续演进的项目。
